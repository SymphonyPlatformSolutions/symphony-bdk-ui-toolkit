(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('prop-types'), require('styled-components'), require('axios')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', 'styled-components', 'axios'], factory) :
  (global = global || self, factory(global.SmsToolkit = {}, global.React, global.PropTypes, global.styled, global.axios));
}(this, function (exports, React, PropTypes, styled, axios) { 'use strict';
  ...
  var BaseBox = styled__default.div(_templateObject(), function (p) {
    return p.display;
  ...
  Box.propTypes = {
    display: PropTypes.PropTypes.string,
    direction: PropTypes.PropTypes.string,
    align: PropTypes.PropTypes.string,
    justify: PropTypes.PropTypes.string,
    grow: PropTypes.PropTypes.string,
    space: PropTypes.PropTypes.number,
    bg: PropTypes.PropTypes.string,
    p: PropTypes.PropTypes.number
  };
  Box.defaultProps = {
    display: 'flex',
  ...
  */
  ...
  var LoaderWrapper = styled__default.div(_templateObject$1());
  ...
  var Container = styled__default(Box)(_templateObject$2());
  var ChildrenContainer = styled__default(Box)(_templateObject2(), function (p) {
    return p.isLoading ? 0.3 : 1;
  }, function (p) {
    return p.isLoading ? 'none' : 'inherit';
  });
  var BaseButton = styled__default.button.attrs({
  ...
  Button.propTypes = {
    ...
    type: PropTypes.PropTypes.oneOf(['primary', 'secondary', 'danger', 'grey']),
    size: PropTypes.PropTypes.string,
    fill: PropTypes.PropTypes.string,
  ...
  var BaseText = styled__default.div(_templateObject$3(), function (props) {
  ...
  Text.propTypes = {
    title: PropTypes.PropTypes.bool,
    size: PropTypes.PropTypes.string,
    underline: PropTypes.PropTypes.bool,
    children: PropTypes.PropTypes.node.isRequired
  };
  Text.defaultProps = {
    title: false,
  ...
  var BaseCard = styled__default.div(_templateObject$4(), function (props) {
  ...
  var CardTitle = styled__default.span(_templateObject2$1(), function (p) {
  ...
  var BaseSeparator = styled__default.div(_templateObject$5(), colors.lightgrey);

  var getTabHeaderBorder = function getTabHeaderBorder(props) {
    console.log(props);
    return '';
  };
  var getTabItemFontWeight = function getTabItemFontWeight(_ref) {
    var activeTab = _ref.activeTab,
        label = _ref.label;
    return activeTab === label ? 'bold' : '100';
  };
  var getTabItemColor = function getTabItemColor(_ref2) {
    var activeTab = _ref2.activeTab,
        label = _ref2.label,
        theme = _ref2.theme;
    return activeTab === label ? theme.theme.primary : theme.theme.darkgrey;
  };
  var getTabItemAlign = function getTabItemAlign(_ref3) {
    var align = _ref3.align;
    return align === 'right' ? 'right' : 'left';
  };
  var getTabHeaderIndicatorMarginLeft = function getTabHeaderIndicatorMarginLeft(_ref4) {
    var activeTabAlign = _ref4.activeTabAlign,
        activeTabIndex = _ref4.activeTabIndex;
    return activeTabAlign === 'right' ? 'calc(100% - 150px)' : "".concat(activeTabIndex * 150, "px");
  };
  var getHeaderIndicatorBackground = function getHeaderIndicatorBackground(_ref5) {
    var theme = _ref5.theme;
  ...
  var BaseTabs = styled__default.div(_templateObject$6());
  var TabHeader = styled__default.ol(_templateObject2$2(), function (props) {
    return getTabHeaderBorder(props);
  });
  var TabHeaderLabel = styled__default.span(_templateObject3$1(), function (props) {
    return getTabItemFontWeight(props);
  }, function (props) {
    return getTabItemColor(props);
  });
  var TabHeaderItem = styled__default.li(_templateObject4(), function (props) {
    return getTabItemAlign(props);
  }, function (props) {
    return getTabItemAlign(props);
  });
  var TabHeaderIndicator = styled__default.div(_templateObject5(), function (props) {
    return getHeaderIndicatorBackground(props);
  }, function (props) {
    return getTabHeaderIndicatorMarginLeft(props);
  });
  function Tabs(props) {
    var _useState = React.useState(props.children[props.activeTab].props.label),
        _useState2 = _slicedToArray(_useState, 2),
        activeTab = _useState2[0],
        setActiveTab = _useState2[1];

    var _useState3 = React.useState(props.activeTab),
        _useState4 = _slicedToArray(_useState3, 2),
        activeTabIndex = _useState4[0],
        setActiveTabIndex = _useState4[1];

    var _useState5 = React.useState(props.children[props.activeTab].props.align),
  ...
  Tabs.propTypes = {
    activeTab: PropTypes.PropTypes.number,
    children: PropTypes.PropTypes.node.isRequired
  };
  Tabs.defaultProps = {
    activeTab: 0
  ...
  var CopyLinkInputWrapper = styled__default.div(_templateObject$7());
  var CopyInput = styled__default.div(_templateObject2$3(), function (p) {
  ...
  var BaseInputField = styled__default.input(_templateObject3$2(), function (props) {
  ...
  InputField.propTypes = {
    copyInput: PropTypes__default.bool,
    disabled: PropTypes__default.bool,
    id: PropTypes__default.string,
    inputState: PropTypes__default.string,
  ...
  MSThemeProvider.propTypes = {
    ...
    themeMap: PropTypes__default.array
  };
  ...
  exports.Loader = Loader$l;
  exports.Logger = instance;
  exports.Separator = Separator;
  exports.Tabs = Tabs;
  exports.Text = Text;
  exports.ThemeProvider = MSThemeProvider;
