...
> The wrapper shown above is a controller for the DynamicPanels. It was implemented with simple tab switching logic, as can be shown below:
>
```jsx
...
Here's a demo with a little more complex adjustments. It mainly implements the example above, with more complex inner components.
