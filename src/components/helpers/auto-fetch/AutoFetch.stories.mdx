...
This is a helper that allows you to automatically plug a **`GET`** REST endpoint
to your component, providing a loading indicator, data array and refresh function to
...
your component with a AutoFetchWrapper Component Tag and give it a configuration. And the other
 is like a [Hook](https://reactjs.org/docs/hooks-intro.html) where in any given component
