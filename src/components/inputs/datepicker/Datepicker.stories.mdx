...
To change the weekday labels, the component can take in an array of 7 strings, each one representing the week day. Following the javascript date standard, the arrats starts off with **Sunday** on index 0.
