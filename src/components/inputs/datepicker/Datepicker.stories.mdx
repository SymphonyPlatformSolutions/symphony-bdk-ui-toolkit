...
import { DatepickerController, RangeController, RangeNavigationController, RangeNavigation1MonthController} from './samples/simple';
...
## Footer navigation 2 months

<Preview>
  <Story name="Footer navigation 2 months">
    <Box>
      <RangeNavigationController />
    </Box>
  </Story>
</Preview>

## Footer navigation 1 month

<Preview>
  <Story name="Footer navigation 1 month">
    <Box>
      <RangeNavigation1MonthController />
    </Box>
  </Story>
</Preview>
