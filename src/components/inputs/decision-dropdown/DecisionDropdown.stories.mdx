...
> **Important note**: in order for the dropdown to function as expected, the menu items all have ```onMouseDown``` events, rather than the usual ```onClick```. Due to this, when writing tests or other programmatical UI handlers, do keep in mind that ```onClick``` will not trigger the correct behavior.
...
<Preview withSource="none">
  <Story name="Simple Content">
    <Box type="flat" style={{ height: '220px', marginTop: '8px'}}>
      <DropdownHandler data={SIMPLE_CONTENT} />
    </Box>
  </Story>
</Preview>

## Simple branch-less dropdown - closeMenuOnSelect=false
...
<Preview withSource="none">
  <Story name="Simple Content no close">
    <Box type="flat" style={{ height: '220px', marginTop: '8px'}}>
      <DropdownHandler data={SIMPLE_CONTENT} closeMenuOnSelect={false} />
    </Box>
  </Story>
</Preview>
    ...
    <Story name="States">
      <Box>
        ...
        <Box align="center" horizontal>
          <Box type="flat" style={{ height: '470px'}}>
...
<Preview>
    <Story name="Loading">
      <Box align="center" horizontal justify="flex-start">
        <Box type="flat" style={{ height: '90px', marginTop: '8px'}}>
...
<Preview>
    <Story name="Multiselect">
      <Box align="center" horizontal justify="flex-start">
        <Box type="flat" style={{ height: '470px', marginTop: '8px'}}>
...
<Preview>
    <Story name="Custom Chevron">
      <Box align="center" horizontal justify="flex-start">
        <Box type="flat" style={{ height: '400px', marginTop: '8px'}}>
