...
<Meta title="Developer Framework/Extension App Template" parameters={{order: 3}}/>

# Extension App Template
---

[![Generic badge](https://img.shields.io/badge/StyledComponents-4.4.1-blue.svg?logo=styled-components)](https://styled-components.com/docs)
[![Generic badge](https://img.shields.io/badge/React-16.12.0-blue.svg?logo=react)](https://pt-br.reactjs.org/blog/2017/09/26/react-v16.0.html)
[![Generic badge](https://img.shields.io/badge/Jest-24.7.1-blue.svg?logo=jest)](https://pt-br.reactjs.org/blog/2017/09/26/react-v16.0.html)
[![Generic badge](https://img.shields.io/badge/webpack-blue.svg?logo=webpack)](https://pt-br.reactjs.org/blog/2017/09/26/react-v16.0.html)

App - Template using Symphony Extension-Api frontend code.
This project contains:

- React, to render the components
- [symphony-bdk-toolkit-ui](https://github.com/SymphonyPlatformSolutions/symphony-bdk-toolkit-ui) Symphony Component
...
![Alt text](readme/project_structure.png?raw=true "Template File structure")
...
![Alt text](readme/enrichment_flow.png?raw=true "Messages Enrichment")
...
![Alt text](readme/authorization_flow.png?raw=true "Messages Enrichment")
