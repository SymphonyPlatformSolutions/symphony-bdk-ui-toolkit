...
<Meta title="Developer Framework/Bot SDK"  parameters={{order: 2}}/>

# Bot SDK
---

[![Generic badge](https://img.shields.io/badge/JDK-1.8-blue.svg?logo=java)](https://www.oracle.com/technetwork/java/javase/documentation/index.html)
[![Generic badge](https://img.shields.io/badge/MAVEN-3.0.5+-blue.svg?logo=apache)](https://maven.apache.org/guides/index.html)

The Bot SDK is managing all bot interactions from handling bot commands to receiving notifications from external
